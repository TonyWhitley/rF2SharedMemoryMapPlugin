...
namespace rF2SharedMemory
{
    ...
    public class rFactor2Constants
    {
        ...
        public const string MM_TELEMETRY_FILE_NAME      = "$rF2.3.8.SMMP_Telemetry$";
        public const string MM_SCORING_FILE_NAME        = "$rF2.3.8.SMMP_Scoring$";
        public const string MM_RULES_FILE_NAME          = "$rF2.3.8.SMMP_Rules$";
        public const string MM_FORCE_FEEDBACK_FILE_NAME = "$rF2.3.8.SMMP_ForceFeedback$";
        public const string MM_GRAPHICS_FILE_NAME       = "$rF2.3.8.SMMP_Graphics$";
        public const string MM_PITINFO_FILE_NAME        = "$rF2.3.8.SMMP_PitInfo$";
        public const string MM_WEATHER_FILE_NAME        = "$rF2.3.8.SMMP_Weather$";
        public const string MM_EXTENDED_FILE_NAME       = "$rF2.3.8.SMMP_Extended$";

        public const string MM_HWCONTROL_FILE_NAME      = "$rF2.3.8.SMMP_HWControl$";
        public const int MM_HWCONTROL_LAYOUT_VERSION = 1;

        public const string MM_WEATHER_CONTROL_FILE_NAME = "$rF2.3.8.SMMP_WeatherControl$";
    ...
    namespace rFactor2Data
    {
        ...
        {
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = rFactor2Constants.MAX_PATH    )]
            char[] userData;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = rFactor2Constants.MAX_PATH    )]
            char[] customVariables;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = rFactor2Constants.MAX_PATH    )]
            char[] stewardResults;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = rFactor2Constants.MAX_PATH    )]
            char[] playerProfile;
        ...
        {
            uint mAppWindow;                      // application window handle
            uint mWidth;                 // screen width
            uint mHeight;                // screen height
            uint mRefreshRate;           // refresh rate
            uint mWindowed;              // really just a boolean whether we are in windowed mode
            byte mOptionsLocation;       // 0=main UI, 1=track loading, 2=monitor, 3=on track
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 31)]
            char[] mOptionsPage;              // the name of the options page
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 204)]
            byte[] mExpansion;      // future use
        };
        public struct SharedMemoryGeneric
        {
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = (int)SharedMemoryEvent.SME_MAX)]
            SharedMemoryEvent[] events;
            long gameVersion;
            float FFBTorque;
        ...
        [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi, Pack = 4)]
        public struct LmuBuffer
        {
            public SharedMemoryGeneric generic;
            public SharedMemoryPathData pathData;

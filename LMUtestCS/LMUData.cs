...
namespace lmuSharedMemory
{
    ...
    {
        public const string MM_LMU_FILE_NAME = "LMU_Data";
        public const string MM_TELEMETRY_FILE_NAME      = "$LMU.3.8.SMMP_Telemetry$";
        public const string MM_SCORING_FILE_NAME        = "$LMU.3.8.SMMP_Scoring$";
        public const string MM_RULES_FILE_NAME          = "$LMU.3.8.SMMP_Rules$";
        public const string MM_FORCE_FEEDBACK_FILE_NAME = "$LMU.3.8.SMMP_ForceFeedback$";
        public const string MM_GRAPHICS_FILE_NAME       = "$LMU.3.8.SMMP_Graphics$";
        public const string MM_PITINFO_FILE_NAME        = "$LMU.3.8.SMMP_PitInfo$";
        public const string MM_WEATHER_FILE_NAME        = "$LMU.3.8.SMMP_Weather$";
        public const string MM_EXTENDED_FILE_NAME       = "$LMU.3.8.SMMP_Extended$";

        public const string MM_HWCONTROL_FILE_NAME      = "$LMU.3.8.SMMP_HWControl$";
        public const int MM_HWCONTROL_LAYOUT_VERSION = 1;

        public const string MM_WEATHER_CONTROL_FILE_NAME = "$LMU.3.8.SMMP_WeatherControl$";
  ...
  namespace LMUData
  {
    ...
    public struct rF2SessionTransitionCapture
    {
      ...
      [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = LMUConstants.MAX_MAPPED_VEHICLES)]
